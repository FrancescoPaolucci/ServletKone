...
public class Ehdokkaat implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "PUOLUE")
    private String puolue;//пол
    @Size(max = 25)
    @Column(name = "KOTIPAIKKAKUNTA")
    private String kotipaikkakunta;//область
    @Column(name = "IKA")
    private Integer ika;//возраст
    @Size(max = 250)
    @Column(name = "MIKSI_EDUSKUNTAAN")
    private String miksiEduskuntaan;//полит. программа
    @Size(max = 2_000)
    @Column(name = "MITA_ASIOITA_HALUAT_EDISTAA")
    private String mitaAsioitaHaluatEdistaa;//изменить
    @Size(max = 50)
    @Column(name = "AMMATTI")
    private String ammatti;//профессия
