...
//	private final ArrayList<Integer> vastaus = new ArrayList<>(20);
	private ArrayList<Integer> vastaus = new ArrayList<>(Vaalikone.numberOfQuestions);
    ArrayList<Tuple<Integer, Integer>> pisteet = new ArrayList<>(Vaalikone.numberOfQuestions);
...
//    }
    ...
    public void taytaVastauksetJaPisteet() {
        ...
        //täytelläänhän listat valmiiksi
        for (int i = 0; i < Vaalikone.numberOfQuestions; i++) {
            this.vastaus.add(0);
            this.pisteet.add(new Tuple<>(0, 0));
        }
