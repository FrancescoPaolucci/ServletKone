    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     	...
     	try { 
             ...
             java.sql.PreparedStatement st = con 
                    .prepareStatement("SELECT KYSYMYS_ID FROM kysymykset ORDER BY KYSYMYS_ID DESC LIMIT 1"); 
             ...
             if (rs.next())
             {
               ...
               numberOfQuestions = Integer.valueOf(placeOne)+1;
             }
        ...
        if (strFunc == null) {
            ...
            if (kysymys_id < numberOfQuestions) {
                try {
